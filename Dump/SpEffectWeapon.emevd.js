...
Event(1670010, Default, function() {
    ...
    EffectTimeReduction(EffectTimeReductionConditions.None, 5);
...
Event(2090000, Default, function() {
    TimeHPRecovery(1, 852, floatArg(8), floatArg(0.25), 1);
});
...
Event(3440000, Default, function() {
    ModifyStatusValue(ChrStatusValue.LevelStatusDexterity, 0, 5);
    LevelStatusCorrection(AttributeType.Adaptability, 0, 99, -3, -3);
});

Event(3810000, Default, function() {
    DeadCountAttackRate(DeadCountAtkRateType.HollowLevel, 0, 10, 1, 0.1, 0);
});
...
Event(5295000, Default, function() {
    GenerateDamageOnce(5295000);
});

Event(5295010, Default, function() {
    DeadCountAttackRate(DeadCountAtkRateType.Sin, 0, 30, 1, 0, 0);
});
...
Event(5410000, Default, function() {
    ...
    ModifyStatusFlag(ChrStatusFlag.FlameWeapon, 0);
    DeadCountAttackRate(DeadCountAtkRateType.HollowLevel, 0, 10, 0.1, 1, 0);
});
...
Event(11750000, Default, function() {
    ModifyStatusValue(ChrStatusValue.HPRecoveryOnKill, 0, 15);
});
...
Event(1630011, Default, function() {
    EffectSFX(5443, 249, SFXDeletionTiming.Invalid, 0, StartAndEndConditions.None, 0);
    TimeHPRecovery(1, 850, 200, floatArg(1), 1);
});
...
Event(1630021, Default, function() {
    EffectSFX(5443, 249, SFXDeletionTiming.Invalid, 0, StartAndEndConditions.None, 0);
    TimeHPRecovery(1, 850, 250, floatArg(1), 1);
});
...
Event(1790020, Default, function() {
    ...
    DeadCountAttackRate(DeadCountAtkRateType.HollowLevel, 0, 0, 1.6, 1.6, 30);
});
...
Event(2760000, Default, function() {
    GenerateDamageOnce(20097100);
});

Event(2760010, Default, function() {
    GenerateDamageOnce(20097110);
});
...
Event(11320000, Default, function() {
    ModifyStatusValue(ChrStatusValue.LevelStatusVigor, 0, 1);
    ModifyStatusValue(ChrStatusValue.LevelStatusEndurance, 0, 1);
    ModifyStatusValue(ChrStatusValue.LevelStatusStrength, 0, 4);
    ModifyStatusValue(ChrStatusValue.LevelStatusDexterity, 0, 4);
    ModifyStatusValue(ChrStatusValue.LevelStatusAdaptability, 0, 1);
...
Event(11290000, Default, function() {
    ...
    TimeHPRecovery(1, 850, 2, floatArg(3), 0);
});
