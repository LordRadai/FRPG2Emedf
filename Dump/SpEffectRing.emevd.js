...
Event(40210000, Default, function() {
    ModifyStatusValue(ChrStatusValue.LevelStatusIntelligence, 0, 5);
});

Event(40220000, Default, function() {
    ModifyStatusValue(ChrStatusValue.LevelStatusFaith, 0, 5);
});
...
Event(40390000, Default, function() {
    ...
    ModifyStatusValue(ChrStatusValue.HPRecoveryOnKill, 0, 30);
    ModifyStatusValue32(ChrStatusValue32.HPRecoveryOnKillSFXID, 0, 934);
    ModifyStatusValue32(ChrStatusValue32.HPRecoveryOnKillSFXDummyPolyID, 0, 249);
});

Event(40390001, Default, function() {
    DisplayIcon(110, StartAndEndConditions.None, 0);
    ModifyStatusValue(ChrStatusValue.HPRecoveryOnKill, 0, 50);
    ModifyStatusValue32(ChrStatusValue32.HPRecoveryOnKillSFXID, 0, 934);
    ModifyStatusValue32(ChrStatusValue32.HPRecoveryOnKillSFXDummyPolyID, 0, 249);
});
...
Event(40390002, Default, function() {
    DisplayIcon(110, StartAndEndConditions.None, 0);
    ModifyStatusValue(ChrStatusValue.HPRecoveryOnKill, 0, 80);
    ModifyStatusValue32(ChrStatusValue32.HPRecoveryOnKillSFXID, 0, 934);
    ModifyStatusValue32(ChrStatusValue32.HPRecoveryOnKillSFXDummyPolyID, 0, 249);
});
...
Event(40400000, Default, function() {
    ...
    TimeHPRecovery(1, 850, 3, floatArg(1.5), 0);
});
...
Event(40750000, Default, function() {
    DisplayIcon(160, StartAndEndConditions.None, 0);
    ModifyStatusValue32(ChrStatusValue32.HPDecreaseValueSpellDarkMagic, 0, 30);
    ModifyStatusValue32(ChrStatusValue32.HPDecreaseValueSpellDarkMiracle, 0, 30);
...
Event(40780000, Default, function() {
    ModifyEstusUsage(EstusModificationType.EstusEffectCorrection, 0);
});
...
Event(41000000, Default, function() {
    ModifyStatusValue(ChrStatusValue.LevelStatusAdaptability, 0, 5);
    ModifyStatusFlag(ChrStatusFlag.EnableSimpletonRing, 0);
});

Event(41010000, Default, function() {
    ModifyStatusValue(ChrStatusValue.LevelStatusStrength, 0, 5);
});
...
Event(41030000, Default, function() {
    ...
    ModifyStatusValue(ChrStatusValue.BlockStaminaDamage, 0, 20);
